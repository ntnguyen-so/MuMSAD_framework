...
#####################################################################
# Nearest Neighbors
python3.8 train_feature_based.py --path=data/normalized/OBSEA_4/TSFRESH_OBSEA_4_minimal.npy --classifier=knn --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_8/TSFRESH_OBSEA_8_minimal.npy --classifier=knn --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_16/TSFRESH_OBSEA_16_minimal.npy --classifier=knn --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_32/TSFRESH_OBSEA_32_minimal.npy --classifier=knn --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_64/TSFRESH_OBSEA_64_minimal.npy --classifier=knn --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_128/TSFRESH_OBSEA_128_minimal.npy --classifier=knn --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_256/TSFRESH_OBSEA_256_minimal.npy --classifier=knn --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_512/TSFRESH_OBSEA_512_minimal.npy --classifier=knn --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_768/TSFRESH_OBSEA_768_minimal.npy --classifier=knn --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_1024/TSFRESH_OBSEA_1024_minimal.npy --classifier=knn --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true

# Linear SVM
python3.8 train_feature_based.py --path=data/normalized/OBSEA_4/TSFRESH_OBSEA_4_minimal.npy --classifier=svc_linear --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_8/TSFRESH_OBSEA_8_minimal.npy --classifier=svc_linear --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_16/TSFRESH_OBSEA_16_minimal.npy --classifier=svc_linear --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_32/TSFRESH_OBSEA_32_minimal.npy --classifier=svc_linear --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_64/TSFRESH_OBSEA_64_minimal.npy --classifier=svc_linear --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_128/TSFRESH_OBSEA_128_minimal.npy --classifier=svc_linear --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_256/TSFRESH_OBSEA_256_minimal.npy --classifier=svc_linear --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_512/TSFRESH_OBSEA_512_minimal.npy --classifier=svc_linear --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_768/TSFRESH_OBSEA_768_minimal.npy --classifier=svc_linear --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_1024/TSFRESH_OBSEA_1024_minimal.npy --classifier=svc_linear --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true

# Decision Tree
python3.8 train_feature_based.py --path=data/normalized/OBSEA_4/TSFRESH_OBSEA_4_minimal.npy --classifier=decision_tree --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_8/TSFRESH_OBSEA_8_minimal.npy --classifier=decision_tree --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_16/TSFRESH_OBSEA_16_minimal.npy --classifier=decision_tree --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_32/TSFRESH_OBSEA_32_minimal.npy --classifier=decision_tree --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_64/TSFRESH_OBSEA_64_minimal.npy --classifier=decision_tree --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_128/TSFRESH_OBSEA_128_minimal.npy --classifier=decision_tree --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_256/TSFRESH_OBSEA_256_minimal.npy --classifier=decision_tree --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_512/TSFRESH_OBSEA_512_minimal.npy --classifier=decision_tree --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_768/TSFRESH_OBSEA_768_minimal.npy --classifier=decision_tree --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_1024/TSFRESH_OBSEA_1024_minimal.npy --classifier=decision_tree --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true

# Random Forest
python3.8 train_feature_based.py --path=data/normalized/OBSEA_4/TSFRESH_OBSEA_4_minimal.npy --classifier=random_forest --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_8/TSFRESH_OBSEA_8_minimal.npy --classifier=random_forest --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_32/TSFRESH_OBSEA_32_minimal.npy --classifier=random_forest --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_64/TSFRESH_OBSEA_64_minimal.npy --classifier=random_forest --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_128/TSFRESH_OBSEA_128_minimal.npy --classifier=random_forest --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_256/TSFRESH_OBSEA_256_minimal.npy --classifier=random_forest --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_512/TSFRESH_OBSEA_512_minimal.npy --classifier=random_forest --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_768/TSFRESH_OBSEA_768_minimal.npy --classifier=random_forest --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_1024/TSFRESH_OBSEA_1024_minimal.npy --classifier=random_forest --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true

# Neural Net
python3.8 train_feature_based.py --path=data/normalized/OBSEA_4/TSFRESH_OBSEA_4_minimal.npy --classifier=mlp --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_8/TSFRESH_OBSEA_8_minimal.npy --classifier=mlp --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_16/TSFRESH_OBSEA_16_minimal.npy --classifier=mlp --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_32/TSFRESH_OBSEA_32_minimal.npy --classifier=mlp --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_64/TSFRESH_OBSEA_64_minimal.npy --classifier=mlp --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_128/TSFRESH_OBSEA_128_minimal.npy --classifier=mlp --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_256/TSFRESH_OBSEA_256_minimal.npy --classifier=mlp --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_512/TSFRESH_OBSEA_512_minimal.npy --classifier=mlp --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_768/TSFRESH_OBSEA_768_minimal.npy --classifier=mlp --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_1024/TSFRESH_OBSEA_1024_minimal.npy --classifier=mlp --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true

# AdaBoost
python3.8 train_feature_based.py --path=data/normalized/OBSEA_4/TSFRESH_OBSEA_4_minimal.npy --classifier=ada_boost --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_8/TSFRESH_OBSEA_8_minimal.npy --classifier=ada_boost --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_16/TSFRESH_OBSEA_16_minimal.npy --classifier=ada_boost --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_32/TSFRESH_OBSEA_32_minimal.npy --classifier=ada_boost --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_64/TSFRESH_OBSEA_64_minimal.npy --classifier=ada_boost --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_128/TSFRESH_OBSEA_128_minimal.npy --classifier=ada_boost --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_256/TSFRESH_OBSEA_256_minimal.npy --classifier=ada_boost --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_512/TSFRESH_OBSEA_512_minimal.npy --classifier=ada_boost --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_768/TSFRESH_OBSEA_768_minimal.npy --classifier=ada_boost --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_1024/TSFRESH_OBSEA_1024_minimal.npy --classifier=ada_boost --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true

# Naive Bayes
python3.8 train_feature_based.py --path=data/normalized/OBSEA_4/TSFRESH_OBSEA_4_minimal.npy --classifier=bayes --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_8/TSFRESH_OBSEA_8_minimal.npy --classifier=bayes --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_16/TSFRESH_OBSEA_16_minimal.npy --classifier=bayes --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_32/TSFRESH_OBSEA_32_minimal.npy --classifier=bayes --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_64/TSFRESH_OBSEA_64_minimal.npy --classifier=bayes --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_128/TSFRESH_OBSEA_128_minimal.npy --classifier=bayes --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_256/TSFRESH_OBSEA_256_minimal.npy --classifier=bayes --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_512/TSFRESH_OBSEA_512_minimal.npy --classifier=bayes --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_768/TSFRESH_OBSEA_768_minimal.npy --classifier=bayes --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_1024/TSFRESH_OBSEA_1024_minimal.npy --classifier=bayes --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true

# QDA
python3.8 train_feature_based.py --path=data/normalized/OBSEA_4/TSFRESH_OBSEA_4_minimal.npy --classifier=qda --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_8/TSFRESH_OBSEA_8_minimal.npy --classifier=qda --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_16/TSFRESH_OBSEA_16_minimal.npy --classifier=qda --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_32/TSFRESH_OBSEA_32_minimal.npy --classifier=qda --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_64/TSFRESH_OBSEA_64_minimal.npy --classifier=qda --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_128/TSFRESH_OBSEA_128_minimal.npy --classifier=qda --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_256/TSFRESH_OBSEA_256_minimal.npy --classifier=qda --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_512/TSFRESH_OBSEA_512_minimal.npy --classifier=qda --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_768/TSFRESH_OBSEA_768_minimal.npy --classifier=qda --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
python3.8 train_feature_based.py --path=data/normalized/OBSEA_1024/TSFRESH_OBSEA_1024_minimal.npy --classifier=qda --file=reproducibility_guide/train_val_split.csv --path_save=results/weights/weights_minimal_normalized/  #--eval-true
