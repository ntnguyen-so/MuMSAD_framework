...
class COPOD(BaseDetector):
    ...
    def __init__(self, contamination=0.1, n_jobs=1):
        super(COPOD, self).__init__(contamination=min(.49,contamination))
        self.n_jobs = n_jobs
    ...
    def fit(self, X, y=None):
        ...
        self.decision_scores_, self.decision_scores_per_var = self.decision_function(X)
        self.X_train = X
    ...
    def decision_function(self, X):
        ...
        if hasattr(self, 'X_train'):
            ...
            decision_scores_per_var = self.O[-original_size:]
        else:
            decision_scores_ = self.O.sum(axis=1)
            decision_scores_per_var_ = self.O
        return decision_scores_.ravel(), decision_scores_per_var_
